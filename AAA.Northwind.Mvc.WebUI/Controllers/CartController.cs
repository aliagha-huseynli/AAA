...
using AAA.Northwind.Mvc.WebUI.ViewComponents;
using Microsoft.AspNetCore.Mvc;

namespace AAA.Northwind.Mvc.WebUI.Controllers
{
    public class CartController : Controller
    {
        ...
        public ActionResult AddToCart(int productId)
        {
            ...
            TempData.Add("message",
                String.Format("Your product, {0}, was successfully added to the cart!", productToBeAdded.ProductName));

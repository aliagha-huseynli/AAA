...
namespace AAA.Northwind.Mvc.WebUI.TagHelpers
{
    ...
    public class PagingTagHelper:TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //    //stringBuilder.AppendFormat("<a href='/product/index? category = @category.CategoryId' class='list - group - item text - decoration - none text - dark'>@category.CategoryName</a>");
